...
const Dapp = () => {
  ...
  const btnAct = 'bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white px-6 py-2 font-semibold rounded-t-[20px]'
  const btnNoAct = 'bg-white px-6 py-2 rounded-t-[20px] border-s-fuchsia-800 font-semibold text-slate-800'
  return (
    <section className='min-h-screen bg-[#f5f5f7] flex flex-col justify-center items-center'>
      ...
      <h1 className='text-8xl text-center font-bold text-slate-800'>Posidonia Dapp</h1>
      <div className='w-[600px] mt-12'>
        ...
        <div className=' w-full bg-white rounded-[20px] max-[360px]:rounded-none px-10 h-96 shadow-2xl flex flex-col items-center'>
